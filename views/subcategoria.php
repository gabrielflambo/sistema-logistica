...
<base href="<?= URL_BASE; ?>">
    ...
    <title>Todas as Sub categorias</title>
        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="search-data container">
                    <h2>Busque Todas as Sub categorias</h2>
                    <div class="filter">
                        <form method="GET" action="subcategory/query">
                    ...
                    <div class="flex">
                        <a href="subcategory/filters/clean" class="btn waves-effect">
                            Limpar Filtros
                        </a>
                        <small>
                            ...
                            <?= (!isset($_SESSION['search']['query'])) ? $subcategory->paging->total : $subcategory->paging->count; ?>
                        </small>
                    </div>
                    <table class="responsive-table">
                        ...
                        <tbody>
                            <?php
                            foreach ($subcategory->result as $item): ?>
                                <tr>
