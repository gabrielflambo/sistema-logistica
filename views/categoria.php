        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="search-data container">
                    <h2>Busque Todas as categorias</h2>
                    <div class="filter">
                        <form method="GET" action="category/query">
                            <label class="col l4 m6 s12">
                                Busca
                    ...
                    <div class="flex">
                        <a href="category/filters/clean" class="btn waves-effect">
                            Limpar Filtros
                        </a>
                        <small>
                            ...
                            <?= (!isset($_SESSION['search']['query'])) ? $category->paging->total : $category->paging->count; ?>
                        </small>
                    </div>
