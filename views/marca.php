        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="search-data container">
                    <h2>Busque Todas as Marcas</h2>
                    <div class="filter">
                        <form method="GET" action="brand/query">
                    ...
                    <div class="flex">
                        <a href="brand/filters/clean" class="btn waves-effect">
                            Limpar Filtros
                        </a>
                        <small>
                            ...
                            <?= (!isset($_SESSION['search']['query'])) ? $brand->paging->total : $brand->paging->count; ?>
                        </small>
                    </div>
