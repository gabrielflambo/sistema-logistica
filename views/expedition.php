            ...
            <section class="row" id="content">
                ...
                <div class="order container create">
                    ...
                    <div class="etiqueta">
                        ...
                        <?php endif; ?>
                        <a target="_blank" class="btn waves-effect" href="print/nota/<?= $order->id; ?>">
                            <span class="fa fa-print"></span>
                            Imprimir Nota Fiscal
                        </a>
                        <a target="_blank" class="btn waves-effect" href="print/conteudo/<?= $order->id; ?>">
                            <span class="fa fa-print"></span>
                            Imprimir Declaração de Contéudo
                        </a>
                    </div>
                    <div class="col m6 s12 item">
                        ...
                        <div class="box">
                            ...
                            <p>
                                ...
                                <?= $order->enderecoEntregaRua; ?>, Nº <?= $order->enderecoEntregaNumero; ?> 
                            </p>
                            <p>
                                <strong>Bairro:</strong>
                                <?= $order->enderecoEntregaBairro; ?>
                            </p>
                            <p>
                                <strong>Cidade:</strong>
                                <?= $order->enderecoEntregaCidade; ?> - <?= $order->enderecoEntregaEstado; ?> 
                            </p>
                            <p>
                                <strong>CEP:</strong>
                                <?= $order->enderecoEntregaCep; ?> 
                            </p>
                            <p>
